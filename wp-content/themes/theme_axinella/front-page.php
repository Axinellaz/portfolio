<?php get_header() ?>
  ...
  <section id="hero" class="banner" >
        ...
        <div class=" menu-icon flowers" id="flower-icon">
                <img class="flower" src=" <?php echo get_template_directory_uri() . '/imgs/flower_menu_burger.png;' ?>" alt="Flower 1">
                <img class="flower" src="<?php echo get_template_directory_uri() . '/imgs/flower_menu_burger_close.png;' ?>" alt="Fleur 2">
                <img class="flower" src=" <?php echo get_template_directory_uri() . '/imgs/flower_menu_burger.png;' ?>" alt="Flower 1">
        </div>
    ...
    <div class="parallax-container">
        <section class="about-me parallax-section" id="about-me" >
